...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="gradient-background_mcmv">
        ...
        <div class="container">
            <div class="mx-auto d-block col-sm-12 col-md-8 col-lg-6 col-xl-6 obgd">
                <div class="row obgd-card"></div>
                <div class="row align-items-center obgd-card">
                    <div class="col">
                        <div class="card">
                            ...
                            <a onmousedown="window.location='/minha-casa_minha-vida'" class="btn btn-primary">Voltar para o início</a>
                            </div>
                        </div>
                    </div>
                </div>
